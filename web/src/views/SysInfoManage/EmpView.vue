<template>
  <div class="mainBox">
    ...
    <div class="query">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline">
        <el-form-item label="姓名">
          <!-- 员工姓名输入框 -->
          <el-input v-model="queryForm.name" placeholder="请输入姓名" style="width: 150px;" clearable/>
        </el-form-item>
    ...
    <!-- 表格弹出框 -->
    <el-dialog v-model="dialogFormVisible" width="600">
...
let jobMap = {1: "班主任", 2: "讲师", 3: "教研主管", 4: "学工主管"};
...
function handleSave() {
  let url = '/emp';
  let method = dialogContent.value === '新增员工' ? 'post' : 'put';
  ...
  apiAxios({
    ...
    if (res.data.code === 200) {
      ElMessage({
        message: dialogContent.value === '新增员工' ? '新增成功！' : '修改成功！',
        type: 'success',
      });
      getEmpList();
